...
class TelaNovasReservas:
    def __init__(self, tela_novas_reservas, tela_suas_reservas, banco, email):
        ...
        # Label "SELECIONE A DATA DA RESERVA"
        ...
        # Labels para os horários de início e fim
        ...
        # Combobox para selecionar a hora de início
        ...
        # Combobox para selecionar a hora de término
    ...
    def voltar_tela_suas_reservas(self):
        # Esconde a tela de novas reservas e mostra a tela de suas reservas
    ...
    def abrir_tela_labs_disponiveis(self):
        # Abre a tela de laboratórios disponíveis
    ...
    def continuar(self):
        # Verifica se os horários selecionados são válidos e, em seguida, abre a tela de laboratórios disponíveis
    ...
    def mostrar_data_selecionada(self, event=None):
        # Obtém a data selecionada no calendário e a exibe na label correspondente
        data_selecionada = self.calendario.get_date()
