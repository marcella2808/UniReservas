...
class TelaReservaConfirmada:
    def __init__(self, tela_reserva_confirmada, data_selecionada, hora_inicio_selecionada, hora_fim_selecionada):
        ...
        self.reserva_confirmada_lbl = ctk.CTkLabel(self.titulo_frame, text='RESERVA CONFIRMADA', font=leaguespartan_font2, text_color='#494949')
        ...
        self.lab_lbl = ctk.CTkLabel(self.infos_frame, text='LAB: ', text_color='#494949', fg_color='#f0f0f0',
                                        width=160, corner_radius=7, font=leaguespartan_font2)
