...
class TelaLogin:
    def __init__(self, tela_login, banco):
        ...
        unireservas_logo = ctk.CTkImage(Image.open('unireservas_logo.png'), size=(200, 200))
        my_label = ctk.CTkLabel(self.frame, text="", image=unireservas_logo)
        ...
        self.email_entry.grid(column=0, row=2, pady=(0, 10))
        ...
        self.senha_entry.grid(column=0, row=4, pady=(0, 15))
